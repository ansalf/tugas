            ...
            <div class="col-md-9">
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class= "tab-pane fade shadow rounded bg-Bright-White show active p-5" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <h3 class="font-italic mb-4">Icon & Illustration</h3>
                        <p class="font-italic text-muted mb-2"><h8> Icon & illustration merupakan bidang yang bertanggung jawab untuk membuat objek visual baik berupa icon, maupun illustration. Dalam pembagian tugas, icon designer memiliki bagian untuk khusus icon sedangkan illustrator khusus memiliki bagian untuk kebutuhan asset illustrasi.
                        </h8>
                        </p>
                        </br>
                        </br>
